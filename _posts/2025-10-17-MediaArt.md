...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around; gap: 10px;">
  <div style="flex-basis: 23%; min-width: 150px;">
    <img src="/assets/images/MediaArt/poster1.png" alt="Exhibition Poster 1" style="width: 100%;">
  </div>
  <div style="flex-basis: 23%; min-width: 150px;">
    <img src="/assets/images/MediaArt/poster2.jpg" alt="Exhibition Poster 2" style="width: 100%;">
  </div>
  <div style="flex-basis: 23%; min-width: 150px;">
    <img src="/assets/images/MediaArt/poster3.jpeg" alt="Exhibition Poster 3" style="width: 100%;">
  </div>
  <div style="flex-basis: 23%; min-width: 150px;">
    <img src="/assets/images/MediaArt/poster4.jpg" alt="Exhibition Poster 4" style="width: 100%;">
  </div>
</div>
...
<a href="/assets/images/MediaArt/snapshots-media_art-only.pdf" target="_blank">
  <img src="/assets/images/MediaArt/snapshot_cover.jpg" alt="Gallery Snapshots PDF Preview" style="width: 80%; margin: 0 auto; display: block; border: 1px solid #ddd;">
</a>
...
1.  **Charye (차례)**  
    ...
    <!-- ![Still from GUT_choice](/assets/images/MediaArt/poster1.png) -->
